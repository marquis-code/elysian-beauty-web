      ...
      >
        ...
        >
          ...
          <div class="flex-1 overflow-y-auto p-6">
              ...
              <div class="flex gap-3">
                <div class="flex-1">
                  <select
                    ...
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary disabled:bg-gray-100 disabled:cursor-not-allowed text-sm"
                  >
                ...
                <button
                  ...
                  class="px-6 py-2.5 bg-primary text-white rounded-full text-sm hover:bg-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm flex items-center gap-2"
                  @click="addWorkingDay"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-if="hasWorkingDays" class="space-y-3 mb-6">
              ...
              <TransitionGroup name="list">
                <div
                  ...
                  :key="workingDay.id"
                  class="bg-gradient-to-r from-primary to-indigo-50 border border-primary rounded-lg p-4 hover:shadow-md transition-all"
                >
                  <div class="flex items-start gap-4">
                    <!-- Day Badge -->
                    <div class="flex-shrink-0 pt-1">
                      <div class="bg-primary text-white px-3 py-1.5 rounded-lg font-semibold text-sm min-w-[100px] text-center">
                        {{ workingDay.day }}
                      </div>
                    </div>
            ...
            <div
              v-else
              class="text-center py-12 bg-gray-25 rounded-lg border-[0.5px] border-dashed border-gray-300"
            >
              <svg class="w-14 h-14 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Footer -->
          <div class="p-4 border-t border-gray-25 bg-gray-25">
            <div class="flex items-center justify-end gap-3">
              <button
                type="button"
                :disabled="createLoading"
                class="px-6 py-2.5 text-sm font-medium text-gray-700 bg-white border-[0.5px] border-gray-300 rounded-full hover:bg-gray-50 transition-colors disabled:opacity-50"
                @click="handleClose"
              >
                Cancel
              </button>
              <button
                ...
                class="px-6 py-2.5 text-sm font-medium text-white bg-primary rounded-full hover:bg-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 min-w-[160px] justify-center"
                @click="handleSubmit"
              >
                <svg
                  v-if="createLoading"
